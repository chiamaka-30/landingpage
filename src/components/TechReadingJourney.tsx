...
const TechReadingJourney = () => {
  return (
    <section className="bg-gradient-to-r from-white to-[#e1f2f6] p-10 rounded-xl border border-gray-200 relative overflow-hidden">
      {/* Grid Background */}
      <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10 pointer-events-none" />

      {/* Title */}
      <h2 className="text-3xl md:text-4xl font-mono font-extrabold text-center mb-10 text-gray-900 relative z-10">
